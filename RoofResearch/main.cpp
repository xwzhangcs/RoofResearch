...
int main(int argc, char** argv)
{
	...
	std::string building = "0220";
	std::string pan_img_file = "../data/building_cluster_" + building + "__OrthoPAN_oriented.png";
	std::string mask_img_file = "../data/building_cluster_" + building + "__segment_oriented.png";
	std::string output_img_file = "../data/building_cluster_" + building + "__clustering.png";
	clustering_kkmeans_mask(pan_img_file, mask_img_file, output_img_file, 2);
	system("pause");
	return 0;
}
