...
def main(aoi_dir, html_file_name):
	...
	for i in range(len(clusters)):
		...
		bld_mask = cluster + '/' + 'building_cluster_' + clusters[i] + '__segment_oriented.png'
		pan_img = cluster + '/' + 'building_cluster_' + clusters[i] + '__OrthoPAN_oriented.png'
		rgb_img = cluster + '/' + 'building_cluster_' + clusters[i] + '__OrthoRGB_oriented.png'
